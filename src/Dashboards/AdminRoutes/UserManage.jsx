        ...
        const fetchUsers = async () => {
            try {
                const response = await axios.get(
                    "http://127.0.0.1:8000/api/admin/all-users",
                    {
                        headers: {
                ...
                const usersWithProperData = (response.data.users || []).map(
                    (user) => ({
                        ...user,
                        is_active:
                            ...
                            {filteredUsers.map((user) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4">
                                            <span
                                                className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium border ${getRoleColor(user.role)}`}
                                            >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <span
                                            className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium border ${getRoleColor(selectedUser.role)}`}
                                        >
                                    ...
                                    <div>
                                        ...
                                        <span
                                            className={`inline-flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium border ${getStatusInfo(selectedUser.is_active).color}`}
                                        >
                                            {
                                                getStatusInfo(
